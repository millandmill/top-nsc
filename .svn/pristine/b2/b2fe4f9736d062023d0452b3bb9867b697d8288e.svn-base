        ...
        <div class="col-xs-12 col-lg-9 col-sm-7 col-md-7">
            <div class="content">
                <div class="header-content">
                    <div class="font24"><i class="fa fa-cubes"></i><?php echo $head; ?>ใบแจ้งหนี้/ใบกำกับภาษี/ใบส่งของ
                        </div>
                    </div>
                                ...
                                <div data-row-span="12">
                                    ...
                                    <div data-field-span="3" style="height: 65px;">
                                        ...
                                        <div class="col-xs-9" style="padding:0px!important;">
                                            <input type="number" pattern="[0-9]" min="0" class="form-control" name="invoice_no" placeholder="   AUTO" value="<?php if(isset($invoice_number)){ echo $invoice_number; } ?>" readonly="readonly">
                                        </div>
                                    </div>
                                </div>
                                <div data-row-span="4">
