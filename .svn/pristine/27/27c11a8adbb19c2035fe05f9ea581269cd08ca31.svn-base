<?php
    ...
    if(isset($billingnote_all)){
        $billing_paper = $billingnote_all[0]['billingnote_paper'];
        $billing_number = $billingnote_all[0]['billingnote_number'];
        $billing_text = $billingnote_all[0]['billingnote_text'];
        $billing_date = $billingnote_all[0]['billingnote_date'];
        $billing_numberOfPurchase = $billingnote_all[0]['numberOfPurchase'];
    }
    if(isset($paper)){
        ...
        <div class="col-xs-12 col-lg-9 col-sm-7 col-md-7">
            <div class="content">
                <div class="header-content">
                    <div class="font24"><i class="fa fa-cubes"></i><?php echo $head; ?>ใบวางบิล
                        </div>
                    </div>
                </div><!-- end header-content -->
                <div class="col-xs-12">
                    <content>
                        <form action="billingnote_add" method="POST" class="grid-form grid-form-special form-addbuy" style="border-top:1px solid #000;border-left:1px solid #000;border-right:1px solid #000;background:#f5f5f5;">
                            <fieldset>
                                <div data-row-span="12">
                                    <div data-field-span="9" style="height: 65px;">
                                        ...
                                        <input type="hidden" name="qText" value="<?php if(isset($resultData[0]['quotation_text'])){ echo $resultData[0]['quotation_text']; } ?>">
                                        <input type="hidden" name="qNumber" value="<?php if(isset($resultData[0]['quotation_number'])){ echo $resultData[0]['quotation_number']; } ?>">
                                    ...
                                    <div data-field-span="3" style="height: 65px;">
                                        ...
                                        <div class="col-xs-3" style="padding:0px!important;">
                                            <input type="text" class="form-control" name="company_format" placeholder=" " style="text-align:center;" value="<?php if(isset($billing_text)){ echo $billing_text; }else{ echo "BN"; } ?>" readonly="readonly">
                                        </div>
                                        <div class="col-xs-9" style="padding:0px!important;">
                                            <input type="number" pattern="[0-9]" min="0" class="form-control" name="invoice_no" placeholder="   AUTO" value="<?php if(isset($billing_number)){ echo $billing_number; } ?>" readonly="readonly">
                                        </div>
                                    </div>
                                </div>
                                <div data-row-span="4">
                                    ...
                                    <div data-field-span="1" style="height: 65px;">
                                        ...
                                        <input type="date" name="due_date" value="<?php if(isset($billing_date)){ echo $billing_date; } else { echo date('Y-m-d'); } ?>">
                                    </div>
                                </div>
                                <div data-row-span="4">
                                    <div data-field-span="3" style="height: 65px;">
                                    ...
                                    <div data-field-span="1" style="height: 65px;">
                                        <label>เลขที่ใบสั่งซื้อ&nbsp;<i class="fa fa-calendar"></i></label>
                                        <input type="text" name="numberOfPurchase" maxlength="10" value="<?php if(isset($billing_numberOfPurchase)){ echo $billing_numberOfPurchase; } ?>">
                                    </div>
                                    <!--<div data-field-span="1" style="height: 65px;">
                                ...
                                <div data-row-span="4">
                                    ...
                                    <div data-field-span="1" style="height: 65px;">
                                        ...
                                        <input type="text" name="reference" value="<?php if(isset($resultData[0]['quotation_text'])){ echo $resultData[0]['quotation_text'].$resultData[0]['quotation_number']; } ?>" disabled>
                                    </div>
                                </div>
                            </fieldset>
                            <!-- here -->
