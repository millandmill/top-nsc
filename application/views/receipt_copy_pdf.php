    ...
    <body>
        <table width="100%" border="0">
            <tr class="linehead">
                ...
                <td width="50%" class="head" style="padding-left: 10px; font-size: 20px; color: #FF69B4"><b><?php if(isset($resultData[0]['company_name'])) { echo $resultData[0]['company_name']; } else { echo ""; }?></b>
                    <font style="font-size: 14px; padding-top: 10px; color: #FF69B4;"><br /><?php if(isset($resultData[0]['company_address_all'])) { echo $resultData[0]['company_address_all']; } else { echo ""; } ?></font>
                    <font style="font-size: 14px; padding-top: 10px; color: #FF69B4;"><br />โทร:&nbsp;<?php if(isset($resultData[0]['company_tel'])) { echo $resultData[0]['company_tel']; } else { echo ""; } ?> แฟกซ์:&nbsp;<?php if(isset($resultData[0]['company_fax'])) { echo $resultData[0]['company_fax']; } else { echo ""; } ?></font>
                    <font style="font-size: 14px; padding-top: 10px; color: #FF69B4;"><br />เลขประจำตัวผู้เสียภาษี:&nbsp;<?php if(isset($resultData[0]['company_tax_code'])) { echo $resultData[0]['company_tax_code']; } else { echo ""; } ?></font>
                </td>
                <td width="40%" class="head" style="text-align: right; color: #FF69B4;"><?php if(isset($resultData[0]['company_email'])) { echo $resultData[0]['company_email']; } ?></td>
            </tr>
        </table>
        <hr style="color: #FFB6C1;" />
        
        <table width="100%" border="0">
            <tr>
                <td class="general_style" colspan="2"><font style="color: #FF69B4;">ชื่อผู้ขาย</font>
                    <br/><br /><font style="color: #FF69B4;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b><?php if(isset($resultData[0]['customer_name'])) { echo $resultData[0]['customer_name']; } ?></b></font>
                    <br/><font style="color: #FF69B4;"><?php if(isset($address)) { echo $address; } ?></font>
                    <br/><font style="color: #FF69B4;"><?php if(isset($resultData[0]['customer_tax_code'])) { echo "เลขประจำตัวผู้เสียภาษี:"." ".$resultData[0]['customer_tax_code']; } ?></font>
                    <br/><font style="color: #FF69B4;"><?php if(isset($resultData[0]['customer_tel'])) { echo "โทร:"." ".$resultData[0]['customer_tel']; } ?></font>&nbsp;&nbsp;&nbsp;&nbsp;<font style="color: #FF69B4"><?php if(isset($resultData[0]['customer_email'])) { echo "อีเมล์:"." ".$resultData[0]['customer_email']; } ?></font>
                </td>
                <td class="receipt_word" colspan="3" >สำเนาใบเสร็จรับเงิน<br />Copy of RECEIPT</td>
            </tr>
        ...
        <table width="100%" border="0">
            <tr>
                <td width="40%" style="color: #FF69B4;">รายละเอียดสินค้า<br />Prod.Description</td>
            ...
            <tr>
                ...
                <?php if($i%2 == 0) { ?>
                    <td width="50%" height="40px" class="data_receipt data_table" style="background: #FFF0F5; padding-left: 5px;"><?php if(isset($resultData[$i]['product_name'])) { echo $resultData[$i]['product_name']; }  ?></td>
                    <td width="15%" class="data_receipt data_table" style="text-align: center; background: #FFF0F5;"><?php if(isset($resultData[$i]['product_amount'])) { echo number_format($resultData[$i]['product_amount']); } ?></td>
                    <td width="15%" class="data_receipt data_table" style="text-align: right; background: #FFF0F5;"><?php if(isset($resultData[$i]['product_price'])) { echo number_format($resultData[$i]['product_price'], 2, '.', ','); } ?></td>
                    <td width="10%" class="data_receipt data_table" style="text-align: right; background: #FFF0F5;"><?php if(isset($resultData[$i]['product_discount'])) { echo $resultData[$i]['product_discount']; } ?></td>
                    <td width="10%" class="data_receipt data_table" style="text-align: right; background: #FFF0F5;"><?php if(isset($resultData[$i]['product_total'])) { echo number_format($resultData[$i]['product_total'], 2, '.', ','); } ?></td>
                <?php }else { ?>
            ...
            <tr>
            <td colspan="2" style="height: 50px; padding-left: 20px; background-color: #FFF0F5;" ><b><?php if(isset($resultData[0]['write_text'])) { echo $resultData[0]['write_text']; } ?></b></td>
                <td colspan="2" style="text-align: center;"><font style="color: #FF69B4;">รวมเงิน<br />SUBTOTAL</font></td>
            ...
            <tr>
                <td rowspan="2" style="padding-left: 20px; padding-top: 30px; padding-bottom: 30px; vertical-align: top; word-wrap: break-word;">
                    <font style="color: #FF69B4;"><b>วันนัดชำระเงิน:</b></font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo date('d/m/Y', strtotime($resultData[0]['payment_date'])); ?><br /><font style="color: #FF69B4;"><b>หมายเหตุ</b></font><br /><br />&nbsp;&nbsp;<?php if(isset($resultData[0]['receipt_note'])) { echo $resultData[0]['receipt_note']; } ?></td>
                <td height="55px;"></td>
                <td colspan="2" style="text-align: center;"><font style="color: #FF69B4;">ภาษีมูลค่าเพิ่ม<br />VAT <?php if(isset($resultData[0]['product_vat'])) { echo $resultData[0]['product_vat']; } ?></font></td>
        ...
        <table width="100%" border="0" style="color: #FF69B4;">
            <tr>
        ...
        <br />
        <hr style="color: #FF69B4;" />
        
        <table width="100%" border="0">
            <tr>
                <td style="text-align: right; color: #FF69B4; font-size: 12px;">เอกสารชุดนี้จัดทำโดย TOP-NSC</td>
            </tr>
        </table>
...
$pdf->SetTitle('Copy of Receipt.pdf');
$pdf->SetAuthor('TOP-NSC');
$pdf->SetAutoFont();
$pdf->SetDisplayMode('fullpage');
$pdf->WriteHTML($html, 0);
$pdf->Output('copy-of-receipt_'.date('d/m/Y', strtotime($resultData[0]['receipt_date'])).'', 'I');
?>