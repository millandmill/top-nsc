    ...
    <body>
        <table width="100%" border="0">
            <tr class="linehead">
                ...
                <td width="40%" class="head font_data_all" style="text-align: right;"><?php if(isset($resultData[0]['company_email'])) { echo $resultData[0]['company_email']; } ?><i class="fa fa-check"></i></td>
            </tr>
        </table>
        ...
        <table width="100%" border="0">
            ...
            <tr>
                ...
                <?php if($i%2 == 0) { ?>
                    <td width="50%" height="40px" class="data_purchase data_table" style="background: #FFEBCD; padding-left: 5px;"><?php if(isset($resultData[$i]['product_name'])) { echo $resultData[$i]['product_name']; }  ?></td>
                    <td width="15%" class="data_purchase data_table" style="text-align: center; background: #FFEBCD;"><?php if(isset($resultData[$i]['product_amount'])) { echo number_format($resultData[$i]['product_amount']); } ?></td>
                    <td width="15%" class="data_purchase data_table" style="text-align: right; background: #FFEBCD;"><?php if(isset($resultData[$i]['product_price'])) { echo number_format($resultData[$i]['product_price'], 2, '.', ','); } ?></td>
                    ...
                    <td width="10%" class="data_purchase data_table" style="text-align: right; background: #FFEBCD;"><?php if(isset($resultData[$i]['product_total'])) { echo number_format($resultData[$i]['product_total'], 2, '.', ','); } ?></td>
                <?php }else { ?>
            ...
            <tr>
                <td rowspan="2" style="padding-left: 20px; padding-top: 30px; padding-bottom: 30px; vertical-align: top; word-wrap: break-word;"><font style="color: #CC3300;"><b>หมายเหตุ</b></font><br /><br />&nbsp;&nbsp;<?php if(isset($resultData[0]['purchase_note'])) { echo $resultData[0]['purchase_note']; } ?></td>
                <td height="55px;"></td>
...
$pdf->Output('purchase_'.date('d/m/Y', strtotime($resultData[0]['purchase_date'])).'', 'I');
?>
