...
?>
        ...
        <div class="col-xs-12 col-lg-9 col-sm-7 col-md-7">
            <div class="content">
                <div class="header-content">
                    <div class="font24"><i class="fa fa-cubes"></i><?php echo $head; ?>ใบเสนอราคา
                        </div>
                    </div>
                </div><!-- end header-content -->
                <div class="col-xs-12">
                    <content>
                        <form action="quotation_add" method="POST" class="grid-form grid-form-special form-addbuy" style="border-top:1px solid #000;border-left:1px solid #000;border-right:1px solid #000;background:#f5f5f5;">
                            <fieldset>
                                <div data-row-span="12">
                                    <div data-field-span="9" style="height: 70px;">
                                        ...
                                        <select name="customer_option" style="width:100%; height:28px; color:#000;">
                                    ...
                                    <div data-field-span="3" style="height: 70px;">
                                        ...
                                        <div class="col-xs-3" style="padding:0px!important;">
                                            <input type="text" class="form-control" name="company_format" placeholder=" " style="text-align:center;" value="<?php if(isset($resultData[0]['quotation_text'])){ echo $resultData[0]['quotation_text']; }else{ echo "QO"; } ?>" readonly="readonly">
                                        </div>
                                        <div class="col-xs-9" style="padding:0px!important;">
                                            <input type="number" pattern="[0-9]" min="0" class="form-control" name="invoice_no" placeholder="   AUTO" value="<?php if(isset($resultData[0]['quotation_number'])){ echo $resultData[0]['quotation_number']; }else{ echo $quotation_paper; } ?>" readonly="readonly">
                                        </div>
                                    </div>
                                </div>
                                <div data-row-span="10">
                                    ...
                                    <div data-field-span="3" style="height: 70px;">
                                        ...
                                        <select name="condition_pay" style="width:30%;color:#000; height:28px;">
                                    ...
                                    <div data-field-span="2" style="height: 70px;">
                                        ...
                                        <input type="date" name="due_date" value="<?php if(isset($resultData[0]['quotation_date'])){ echo $resultData[0]['quotation_date']; } else { echo date('Y-m-d'); } ?>">
                                    </div>
                                </div>

                                <div data-row-span="10">
                                    <div data-field-span="8" style="height: 70px;">
                                        <label>ที่อยู่</label>
                                        <input type="text" name="address" value="<?php if(isset($address)){ echo $address; } ?>" >
                                    </div>
                                    <div data-field-span="2" style="height: 70px;">
                                        <label>ลงวันที่&nbsp;<i class="fa fa-calendar"></i></label>
                                        <input type="date" id="is_date" name="is_date" value="<?php if(isset($resultData[0]['issue_date'])){ echo $resultData[0]['issue_date']; } else { echo date('Y-m-d'); } ?>">
                                    </div>
                                </div>
                                <div data-row-span="8">
                                    <div data-field-span="2" style="height: 70px;">
                                    ...
                                    <div data-field-span="2" style="height: 70px;">
                                        <label>วันกำหนดส่ง&nbsp;<font color="red"><sup>*จำเป็น</sup></font><i class="fa fa-calendar"></i></label>
                                        <input type="date" id="con_date" name="con_date" onchange="calculateDate()" value="<?php if(isset($resultData[0]['condition_date'])){ echo $resultData[0]['condition_date']; } else { echo date('Y-m-d'); } ?>">
                                    </div>
                                    <input type="hidden" id="hidden_date" name="hidden_date" value="<?php if(isset($resultData[0]['payment_date'])){ echo $resultData[0]['payment_date']; } else { echo date('Y-m-d'); } ?>">
                                </div>
                            </fieldset>
                            <!-- here -->
                        <div class="row row-0">
                            ...
                            <table class="table table-bordered table-pink" style="background:#f5f5f5;" id="myTable">
                              <thead class="invoice">
                                <tr>
                                  ...
                                  <th style="width:16%">
                                    <select id="price_option" name="price_option" style="width:100%;color:#000;" onchange="autoCalculate(this);">
                              ...
                              <tbody class="grid-form" id="content">
                                <?php for($i=0; $i<$chkLoop; $i++){ ?>
                                    <tr>
                                        ...
                                        <?php } ?>
                                        <td>
                                            <input type="text" name="discount[]" onchange="autoCalculate()" value="<?php if(isset($resultData[$i]['product_discount'])){ echo $resultData[$i]['product_discount']; } ?>">
                                        </td>
                                        <td>
                                            <input type="text" name="amount[]" class="amount" onkeydown="last_line(event,$(this));" min="0" style="text-align:right;" value="<?php if(isset($resultData[$i]['product_total'])){ echo $resultData[$i]['product_total']; } ?>" readonly="readonly">
                                        </td>
                              ...
                              <tfoot class="grid-form">
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" style="text-align:right;" name="sum_amount" value="<?php if(isset($resultData[0]['product_total_real'])){ echo $resultData[0]['product_total_real']; }else{ echo "0.00"; }?>" onkeyup="calculate_grand_total();return false;" readonly="readonly"></td>
                                    <td></td>
                                </tr>
                                <tr>
                                    <td colspan="4"></td>
                                    ...
                                    <td><input id="sum_tax" type="text" style="text-align:right;" name="sum_tax" value="<?php if(isset($resultData[0]['product_vat'])){ echo $resultData[0]['product_vat']; }else{ echo "7%"; } ?>" onkeyup="autoCalculate();" readonly="readonly"></td>
                                    <td></td>
                                </tr>
                                <tr>
                                    ...
                                    <td><input type="text" style="text-align:right;" name="grand_total" value="<?php if(isset($resultData[0]['product_grand_total'])){ echo $resultData[0]['product_grand_total']; }else{ echo "0.00"; }?>" readonly="readonly"></td>
                                    <td></td>
                                </tr>
                                <tr>
        ...
        <table style="display:none;">
            <tbody id="content_to_be_added">
                <tr>
                    <td>
                        <input type="text" name="id[]" onkeyup="auto_product($(this));return false;" readonly="readonly">
                    </td>
                    <td>
                    ...
                    <td>
                        <input type="number" pattern="[0-9]" name="price[]" min="0" onchange="autoCalculate()">
                    </td>
                    <td>
                        <input type="number" pattern="[0-9]" name="quantity[]" min="1" onchange="autoCalculate()">
                    </td>
                    <td>
                        <input type="text" name="discount[]" onkeyup="autoCalculate()">
                    </td>
                    <td>
                        <input type="text" name="amount[]" class="amount" onkeydown="last_line(event,$(this));" style="text-align:right;" readonly="readonly">
                    </td>
                    <td style="text-align:center;vertical-align:middle;">
                        <button class="btn btn-grey" onclick="delete_this_line($(this));" tabindex="-1">
                            <i class="fa fa-remove"></i>
...
<script>
    ...
    function calculateDate(){
        ...
        var due_date = document.getElementsByName("con_date");
        ...
        $("#hidden_date").val(final_date.toString());
    }
