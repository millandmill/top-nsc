    ...
    <body>
        <table width="100%" border="0">
            <tr class="linehead">
                ...
                <td width="50%" class="head" style="padding-left: 10px; font-size: 20px;"><font style="color: #FA8072;"><b><?php if(isset($resultData[0]['company_name'])) { echo $resultData[0]['company_name']; } else { echo ""; }?></b></font>
                ...
                <td width="40%" class="head font_data_all" style="text-align: right; color: #FA8072;"><?php if(isset($resultData[0]['company_email'])) { echo $resultData[0]['company_email']; } ?><i class="fa fa-check"></i></td>
            </tr>
        </table>
        ...
        <table width="100%" border="0">
            <tr>
                <td class="general_style" colspan="2"><font class="font_data_all" style="color: #FA8072;">ชื่อผู้ขาย</font>
                    <br/><br /><font style="color: #FA8072">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b><?php if(isset($resultData[0]['customer_name'])) { echo $resultData[0]['customer_name']; } ?></b></font>
                ...
                <td class="purchase_word" colspan="3" >สำเนาใบสั่งซื้อ<br />Copy of PURCHASE ORDER</td>
            </tr>
        ...
        <table width="100%" border="0">
            <tr>
                <td width="40%" style="color: #FA8072;">รายละเอียดสินค้า<br />Prod.Description</td>
            ...
            <tr>
                ...
                <?php if($i%2 == 0) { ?>
                    <td width="50%" height="40px" class="data_purchase data_table" style="background: #FDF5E6; padding-left: 5px;"><?php if(isset($resultData[$i]['product_name'])) { echo $resultData[$i]['product_name']; }  ?></td>
                    <td width="15%" class="data_purchase data_table" style="text-align: center; background: #FDF5E6;"><?php if(isset($resultData[$i]['product_amount'])) { echo number_format($resultData[$i]['product_amount']); } ?></td>
                    <td width="15%" class="data_purchase data_table" style="text-align: right; background: #FDF5E6;"><?php if(isset($resultData[$i]['product_price'])) { echo number_format($resultData[$i]['product_price'], 2, '.', ','); } ?></td>
                    <td width="10%" class="data_purchase data_table" style="text-align: right; background: #FDF5E6;"><?php if(isset($resultData[$i]['product_discount'])) { echo $resultData[$i]['product_discount']; } ?></td>
                    <td width="10%" class="data_purchase data_table" style="text-align: right; background: #FDF5E6;"><?php if(isset($resultData[$i]['product_total'])) { echo number_format($resultData[$i]['product_total'], 2, '.', ','); } ?></td>
                <?php }else { ?>
                    <td width="50%" height="40px" class="data_purchase data_table" style="padding-left: 5px;"><?php if(isset($resultData[$i]['product_name'])) { echo $resultData[$i]['product_name']; } ?></td>
                    <td width="15%" class="data_purchase data_table" style="text-align: center;"><?php if(isset($resultData[$i]['product_amount'])) { echo number_format($resultData[$i]['product_amount']); } ?></td>
                    <td width="15%" class="data_purchase data_table" style="text-align: right;"><?php if(isset($resultData[$i]['product_price'])) { echo number_format($resultData[$i]['product_price'], 2, '.', ','); } ?></td>
                    ...
                    <td width="10%" class="data_purchase data_table" style="text-align: right;"><?php if(isset($resultData[$i]['product_total'])) { echo number_format($resultData[$i]['product_total'], 2, '.', ','); } ?></td>
                <?php } ?>
            </tr>
             <?php } ?>
            ...
            <tr>
            <td colspan="2" style="height: 50px; padding-left: 20px; background-color: #FDF5E6;" ><b><?php if(isset($resultData[0]['write_text'])) { echo $resultData[0]['write_text']; } ?></b></td>
            ...
            <tr>
                <td rowspan="2" style="padding-left: 20px; padding-top: 30px; padding-bottom: 30px; vertical-align: top; word-wrap: break-word;"><font style="color: #FA8072;"><b>หมายเหตุ</b></font><br /><br />&nbsp;&nbsp;<?php if(isset($resultData[0]['purchase_note'])) { echo $resultData[0]['purchase_note']; } ?></td>
                <td height="55px;"></td>
...
$pdf->SetTitle('Copy of Purchase.pdf');
$pdf->SetAuthor('TOP-NSC');
$pdf->SetAutoFont();
$pdf->SetDisplayMode('fullpage');
$pdf->WriteHTML($html, 0);
$pdf->Output('copy-of-purchase_'.date('d/m/Y', strtotime($resultData[0]['purchase_date'])).'', 'I');
?>
