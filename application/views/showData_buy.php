                    ...
                    <?php if(isset($resultData)){ ?>
                        <?php for($i=0; $i<$count; $i++){ ?>
                            <tr>
                                ...
                                <td><?php if(isset($resultData[$i]['purchase_text'])){ echo $resultData[$i]['purchase_text'].$resultData[$i]['purchase_number']; } ?></td>
                                <td><?php if(isset($resultData[$i]['purchase_date'])){ echo date("d/m/Y", strtotime($resultData[$i]['purchase_date'])); } ?></td>
                                <td><?php if(isset($resultData[$i]['quotation_number'])){ echo $resultData[$i]['quotation_number']; } ?></td>
